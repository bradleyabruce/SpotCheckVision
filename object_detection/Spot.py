...
def decoder(obj):
    spot = Spot(obj['spotId'], obj['open'], obj['deviceId'], obj['topLeftXCoordinate'], obj['topLeftYCoordinate'], obj['bottomRightXCoordinate'], obj['bottomRightYCoordinate'], 0, 0, obj['updateDate'])
    return spot
